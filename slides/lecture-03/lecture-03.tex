...
\begin{frame}<-2>[fragile]{Aparté: segmentation et repérage}
	...
	\begin{tikzpicture}[true scale=0.6]
		\matrix[matrix of nodes, anchor=base, row sep=0em, column sep=0em, row 2/.style={font=\large\fallbackfont}] (m) {
			C' & étaient & Susan & Calvin & et & Alfred & Lanning & de & l' & US & Robots\\
			|[sronbrightred]| ✗ & |[sronbrightred]| ✗ & |[sronbrightgreen]| ✓ & |[sronbrightgreen]| ✓ & |[sronbrightred]| ✗ & |[sronbrightgreen]| ✓ & |[sronbrightgreen]| ✓ & |[sronbrightred]| ✗ & |[sronbrightred]| ✗ & |[sronbrightred]| ✗ & |[sronbrightred]| ✗\\
		};
	\end{tikzpicture}
\end{frame}
