...
\begin{frame}{Caractérisation}
    ...
    On peut considérer chaque tâche comme une \aler{boîte noire} : la façon dont le programme fonctionne ne nous intéresse pas ici.
\end{frame}
...
\begin{frame}[fragile=singleslide]{Documents semi-structuré}
    ...
    \begin{figure}
        ...
        \begin{forest}
            ...
            [\mintinline{<tab}le>
                [\mintinline{<tr>}
                    [\mintinline{<th>} produit ]
                    [\mintinline{<th>} marque ]
                    [\mintinline{<th>} {prix en euros} ]
                ]
                [\mintinline{<tr>}
                    [\mintinline{<td>} {ordinateur portable} ]
                    [\mintinline{<td>} truc ]
                    [\mintinline{<td>} 800 ]
                ]
                [\mintinline{<tr>}
                    [\mintinline{<td>} tablette ]
                    [\mintinline{<td>} machin ]
                    [\mintinline{<td>} 200 ]
                ]
            ]
        \end{forest}
