...
\begin{frame}[fragile=singleslide]{Annotation}
    L'\emph{annotation} ou \emph{étiqutage de séquences} est la tâche consistant à attribuer une étiquette à chaque élément d'une séquence.
    ...
    \vskip-1em
    \begin{itemize}
        \item La \textcolor{highlight4}{donnée} à annoter est composée de plusieurs unités et munie d'une structure d'ordre
