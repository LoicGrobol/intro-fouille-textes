...
\begin{frame}[fragile]{Fonction de Heavyside}
    La fonction de Heavyside $H$ est l'activation classique pour faire du perceptron un classifieur binaire : elle transforme les nombres négatifs en $09$ et les nombres positifs en $1$.
    \begin{figure}
        \tikzset{external/export=true}
        \begin{tikzpicture}
            \begin{axis}[xmin=-10, xmax=10,
                         ...
                         scaled ticks=false,]
                \addplot[highlighta, domain=-10:10, samples=100] {greater(x,0)};
            \end{axis}
        \end{tikzpicture}
    ...
    \begin{figure}
        ...
        \begin{tikzpicture}
            ...
            \foreach \x/\y/\c [count=\i] in {2/1/6,4/0/6,1/0/6,2/3/6,0/3/a,1/2/a,0/2/a}{
                \path[alt=<\i>{highlight5}{fill=highlight\c}] (\x, \y) circle[radius=3pt];
            }
            \begin{scope}[domain=-0.5:5.25]
                    \draw[highlight3, thick] plot (\x, 0);
            \end{scope}
        \end{tikzpicture}
