...
\begin{frame}[fragile]{Aparté : micro-average et exactitude}
    ...
    \end{theorem}
    On considère la matrice de confusion suivant
    \begin{center}
        \tikzset{external/export=true}
        \begin{tikzpicture}[
            table/.style={
        ...
        \item Fouille d'arguments
            \begin{itemize}
                \item Aide à la décision (politique)
                    \begin{itemize}
                        \item[→] IBM Watson \shorturl{youtube.com/watch?v=sEf0GLvrP9U}
                    \end{itemize}
                \item Aide à la lecture (judiciaire, scientifique)
                    \begin{itemize}
                        \item[→] « Argument zoning » \shorturl{www.cl.cam.ac.uk/~sht25/az.html}
                    \end{itemize}
            \end{itemize}
        \item …
    \end{itemize}
