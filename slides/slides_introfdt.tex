...
\begin{frame}{Informations pratiques}
    \begin{description}[Contact]
        ...
        \item[Contact] \href{mailto:loic.grobol@gmail.com}{\texttt{loic.grobol@gmail.com}}
        \item[Web] \href{https://loicgrobol.github.io/intro-fouille-textes}{\small\texttt{loicgrobol.github.io/intro-fouille-textes}}
    \end{description}
\end{frame}
...
\begin{frame}{Organisation}
    \begin{description}[Évaluation]
        \item[Poly] À lire d'une fois sur l'autre :
                    \href{https://loicgrobol.github.io/intro-fouille-textes/poly/poly.pdf}{\footnotesize\texttt{loicgrobol.github.io/intro-fouille-textes/poly/poly.pdf}}
...
\begin{frame}{Quelques ressources linguistiques}
    \begin{itemize}
        \item Le Lexique Extensionnel des Formes Fléchies du Français (Lefff)
            \begin{itemize}
                \item[→] \url{http://almanach.inria.fr/~sagot/lefff.html}
            \end{itemize}
        \item La base de connaissances structurée Wikidata
            \begin{itemize}
                \item[→] \url{https://www.wikidata.org}
            \end{itemize}
        \item Le segmenteur/étiqueteur/parser UDPipe
            \begin{itemize}
                \item[→] \url{http://ufal.mff.cuni.cz/udpipe}
            \end{itemize}
        \item Le corpus arboré pour le français (French Treebank)
            \begin{itemize}
                \item[→] \url{http://ftb.linguist.univ-paris-diderot.fr/ }
            \end{itemize}
        \item Le réseau lexical JeuxDeMots
            \begin{itemize}
                \item[→] \url{http://www.jeuxdemots.org/jdm-about.php}
            \end{itemize}
    \end{itemize}
\end{frame}
...
\begin{frame}{Programmes}
    ...
    \begin{itemize}
        \item[→] FRMG (\url{http://alpage.inria.fr/frmgwiki/})
    \end{itemize}
\end{frame}
