...
\begin{frame}{Similarité : exemple de travail}
    ...
    \begin{itemize}
        ...
        \item On va pour se forger une intuition géométrique se restreindre au cas de la dimension $2$
    \end{itemize}
\end{frame}
...
% TODO: distances comparisons (particularly minkovsky) : show distorted diagrams, + x→||u-v||_x curve
        ...
        \column{.5\textwidth}
            \begin{figure}
                ...
                \begin{tikzpicture}[true scale=0.7]
                    ...
                    \draw [<->, highlight2] (1, 2) --  (3, 2) node [midway, above] {$\abs{1-3}$};
