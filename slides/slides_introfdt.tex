    ...
    \only<1-4>{
        \begin{figure}
            ...
            \begin{tikzpicture}
                ...
                \draw[->, highlight4, line width=2pt, alt=<3->{}{invisible}] (0,0) -- (4,3) node[midway, alt=<3>{below right}{above}] {$u+v$};
            \end{tikzpicture}
...
\begin{frame}[fragile]{Distance de Manhattan}
    ...
    \only<1>{
        ...
        \begin{figure}
            % \tikzset{external/export=true}
            \begin{tikzpicture}
                \draw [xstep=1, ystep=1, line width=5pt] (0, 0) grid (5, 5);
                \fill[highlight3] (0, 0) circle [radius=2pt];
                \fill[highlight3] (5, 5) circle [radius=2pt];
                \draw[highlight0] (0, 0) -| (5, 5);
                \draw[highlight6] (0, 0) |- (5, 5);
                \draw[highlight4] (0, 0) |- (2,3) -| (5, 5);
            \end{tikzpicture}
            \caption{Exemple de travail}
        \end{figure}
    }
        ...
        \column{.4\textwidth}
            \begin{align}
                \norm{t_2-t_1}_1
                    ...
                    &= \abs{v_{2,1}-v_{1,1}}+\abs{v_{2,2}-v_{1,2}}\\
                    &= \abs{1-3}+\abs{2-1}\\
                    &= 2+1\\
                    &= 3
            \end{align}
        \column{.6\textwidth}
            \begin{figure}
                ...
                \begin{tikzpicture}
                    ...
                    \draw [->, highlighta, line width=2pt] (0,0) -- (3,1) node[midway, above] {$t_1$};
                    \draw [->, highlight3, line width=2pt] (0,0) -- (1,2) node[midway, above left] {$t_2$};
                    \draw [<->] (1, 2) --  (3, 2) node [midway, above] {$\abs{1-3}$} -- (3, 1)  node [midway, right] {$\abs{2-1}$};
                \end{tikzpicture}
...
\begin{frame}{Similarité cosinus}
    \begin{block}{Définition (similarité cosinus)}
        On appelle \emph{similarité cosinus} entre $t_1$ et $t_2$ le nombre
        \begin{equation}
