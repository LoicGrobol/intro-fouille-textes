...
\NewDocumentCommand\docdate{}{2019-02-11}
...
\begin{frame}[fragile]{L'annotation comme une suite de classifications}
    \begin{figure}
        \tikzset{external/export=true}
        \begin{tikzpicture}[
                row 2 column 1/.style={visible on=1},
                row 2 column 2/.style={visible on=2},
                row 2 column 3/.style={visible on=3},
                row 2 column 4/.style={visible on=4},
