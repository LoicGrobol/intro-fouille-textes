...
\begin{frame}{Arbre de décision}
    Modèle de prise de décision déterministe par succession de choix.: $k$-NN
    \begin{figure}
        \tikzset{external/export=true}
        \begin{forest}
...
\begin{frame}[fragile=singleslide]{Exercice}
	...
	\begin{table}
		\begin{tabu} to .9\linewidth {*{5}{c}}
			\texttt{t}  & spirou  & fantasio & gaston & classe\\
			\hline
			\texttt{1}  & oui      & oui		& non	& T. et J.\\
			\texttt{2}  & oui      & non	& non	& T. et J.\\
			\texttt{3}  & non      & oui	& oui	& Franquin\\
			\texttt{4}  & oui      & oui	& oui	& Franquin\\
		\end{tabu}
	\end{table}
\end{frame}
